...
function isMirror(root1: Nullable<TreeNode<number>>, root2: Nullable<TreeNode<number>>): boolean {
...
const root1: TreeNode<number> = createTree([1,3,2,,,5,4]) as TreeNode<number>;
