...
function preorderTraversal(root: TreeNode | null): number[] {
    /**
     * in preorder , print root, left & right
     * if queue is used --> it will result in level order traversal or BFS
     * so we need queue. but in this case since we need to process left before right
     * we will first need to push right & then right
     */
